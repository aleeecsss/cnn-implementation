#ifndef DENSELAYER_RELU_H_INCLUDED
#define DENSELAYER_RELU_H_INCLUDED

class denseLayer_ReLU : public denseLayer, public ReLU {
    public:
        denseLayer_ReLU(int _n, int _m) : 
            denseLayer(_n, _m), ReLU(_m) {
            n = _n, m = _m;
            sz = n;
            nxtSz = m;
...
#endif // DENSELAYER_RELU_H_INCLUDED
